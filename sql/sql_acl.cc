...
static my_bool acl_load(THD *thd, TABLE_LIST *tables)
{
  ...
  if (init_read_record(&read_record_info,thd,table=tables[1].table,NULL,1,1, FALSE))
    goto end;
  table->use_all_columns();
  ...
  if (init_read_record(&read_record_info,thd,table=tables[2].table,NULL,1,1,FALSE))
    goto end;
  table->use_all_columns();
  ...
  if (tables[3].table)
  {
    if (init_read_record(&read_record_info, thd, table= tables[3].table, NULL, 1, 
                         1, FALSE))
      goto end;
    table->use_all_columns();
    while (!(read_record_info.read_record(&read_record_info)))
